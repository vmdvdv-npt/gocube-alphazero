...
def canonical_matrix(
    ...
    *,
    ...
    rows = (
        ...
        MatrixRow("pass-alive", 2, "pinned KataGo + independent vital-region/placement proof", True, True, "Cube/Torus smoke"),
        ...
        MatrixRow("seki", 1, "independent bounded exhaustive continuation + KataGo seki-tax analog", False, True, "24 per rotation-safe fixture"),
        MatrixRow("dame", 1, "independent mixed-border region proof", False, True, "24 per rotation-safe fixture"),
