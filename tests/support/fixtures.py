...
def cube_verification_fixtures() -> tuple[VerificationFixture, ...]:
    ...
    fixtures = (
        ...
        _cube4_fixture(
            ...
            expected={"group_count": 2, "not_adjacent": True},
        ...
        _cube4_fixture(
            ...
            actions=("top:3:0",),
            expected={"captured_group_count": 3, "capture_count": 4, "legal": True, "own_liberties_after": 4},
        ...
        _cube4_fixture(
            ...
            white=q_neighbors,
            actions=(q,),
            expected={"captured_group_count": 4, "capture_count": 4, "same_group_not_double_counted": True, "legal": True},
        ...
        _cube4_fixture(
            ...
            to_move="white",
            actions=(q,),
            expected={"legal": False, "reason": "suicide", "capture_count": 0},
        ...
        _cube4_fixture(
            ...
            expected={"status": "unknown", "structural": "two_empty_components"},
        ...
        _cube4_fixture(
            ...
            white=("front:1:1",),
            expected={"status": "unknown", "structural": "mixed_border"},
            oracle="structural-only",
        ...
        _cube4_fixture(
            ...
            "eyes",
            black=("front:0:1", "left:0:2"),
            expected={"region_count": "independent_graph", "crosses_seam": True},
        ...
        _cube4_fixture(
            ...
            expected={"status": "structural-only", "shared_empty_region": True, "score": "unknown"},
            oracle="structural-only",
        ...
        _cube4_fixture(
            ...
            black=("front:0:0",),
            white=("back:0:0",),
            expected={"status": "structural-only", "neutral_region": True, "score": "unknown"},
            oracle="structural-only",
        ...
        _cube4_fixture(
            ...
            "global_connectivity",
            black=("front:0:0", "left:0:3", "top:3:0"),
            expected={"group_count": 1, "path_faces": ["front", "left", "top"]},
        ...
        _cube4_fixture(
            ...
            white=("front:2:2",),
            expected={"pass_alive_area": "pending_independent_proof", "intruder": "white:front:2:2", "score": "unknown"},
