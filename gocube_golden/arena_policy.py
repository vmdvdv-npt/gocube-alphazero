...
This module contains policy metadata and guards only. Runtime execution lives
outside the Golden core so the Golden package remains free of operational
parallel/inference dependencies.
"""
...
def require_current_torus9_production_ready() -> None:
    if not CURRENT_TORUS9_PRODUCTION_ARENA_READY:
        raise ArenaPolicyError(
            ...
            "start until 16 CPU search workers + one central CUDA inference broker "
