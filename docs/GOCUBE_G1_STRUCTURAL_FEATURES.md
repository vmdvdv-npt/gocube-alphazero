...
network.  The production pinned observation now contains the existing dynamic
game-state channels plus two deterministic point channels:
...
The G1 production identities are:
