...
- structured files from `training_reports/c4-hparam-night-20260906-005747-preflight/publish/`, when present
...
Full wrapper console output remains local at `training_reports/c4-hparam-night-20260906-005747-preflight/console.log`.
