...
```bash
/home/codex/projects/gocube-alphazero/.venv/bin/python /home/codex/.cache/gocube-night-tools-2a8e15c796a8390aae6ed68c13c3688fcd1383eb/c4_overnight_experiment.py --experiment-id c4-hparam-night-20260906-005023 --source-run c4-t001-c4-c001 --frozen-commit 85c87a7cfd467a4d3f4b2844253fb63d746d672a --max-hours 8
```
...
- structured files from `training_reports/c4-hparam-night-20260906-005023/publish/`, when present
...
Full wrapper console output remains local at `training_reports/c4-hparam-night-20260906-005023/console.log`.
