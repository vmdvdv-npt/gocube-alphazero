...
_authoritative_game_class = _impl._authoritative_game_class
...
_require_compatible_contracts = _impl._require_compatible_contracts
_resolve_checkpoint_contract = _impl._resolve_checkpoint_contract
